package practice.java.practice_8.library;

import practice.java.practice_8.library.exceptions.BookNotFoundException;
import practice.java.practice_8.library.exceptions.InvalidBookException;
